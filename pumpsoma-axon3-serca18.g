...
str plctype="mm"
lightdelay=2000
str filepath="/Users/avrama/genesis-scripts/ncx/results/"
...
int isi, start
  ...
  for (isi=-1000; isi<=1000; isi=isi+2000)
    ...
    setfield /stat/spike_rate peak 0.15 tau_fall 1000 decay_type 0 delay {start}
     ...
     str filenam = (filepath)@"pumpsoma-axon3-serca18"@(isi/1000)@".dat"
     setfield /output/plot_out filename {filenam} initialize 1 append 0 leave_open 1

     str filenam = (filepath)@"pumpsoma-axon3-serca18"@(isi/1000)@".cal"
...
/* light alone */
    setfield /stat/spike_rate peak 0.0 tau_fall 1000 decay_type 0 delay 16000
     ...
     str filenam = (filepath)@"pumpsoma-axon3-serca18-light.dat"
     setfield /output/plot_out filename {filenam} initialize 1 append 0 leave_open 1

     str filenam = (filepath)@"pumpsoma-axon3-serca18-light.cal"
     setfield /output/spatial filename {filenam} initialize 1 append 0 leave_open 1
...
/* GABA alone */
    ...
    setfield /rhabmemb/shutter level1 0 delay1 16000 width1 0
     ...
     str filenam = (filepath)@"pumpsoma-axon3-serca18-gaba.dat"
     setfield /output/plot_out filename {filenam} initialize 1 append 0 leave_open 1

     str filenam = (filepath)@"pumpsoma-axon3-serca18-gaba.cal"
     setfield /output/spatial filename {filenam} initialize 1 append 0 leave_open 1
